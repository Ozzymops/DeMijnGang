				...
				<div class="inside">
					...
					<div>
						<form action="" method="post" class="em-booking-single-status-info">
							...
							<input type="button" class="button-secondary em-booking-submit-status-modify" id="em-booking-submit-status-modify" value="<?php esc_attr_e_emp('Change', 'events-manager'); ?>" />
							<input type="submit" class="button-primary em-booking-resend-email" id="em-booking-resend-email" value="<?php esc_attr_e_emp('Resend Email', 'events-manager'); ?>" />
						...
						<form action="" method="post" class="em-booking-single-status-edit">
							...
							<input type="submit" class="button-primary em-booking-submit-status" id="em-booking-submit-status" value="<?php esc_attr_e_emp('Submit Changes', 'events-manager'); ?>" />
							<input type="button" class="button-secondary em-booking-submit-status-cancel" id="em-booking-submit-status-cancel" value="<?php esc_attr_e_emp('Cancel', 'events-manager'); ?>" />
