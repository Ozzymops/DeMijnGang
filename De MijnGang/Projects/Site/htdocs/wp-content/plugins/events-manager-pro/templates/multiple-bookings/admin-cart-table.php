			...
			<tr class="em-cart-table-event-summary" id="em-cart-table-event-summary-<?php echo $EM_Booking->get_event()->event_id; ?>">
				<td>
					...
					<div class="em-cart-table-details-actions">
						<a href="<?php echo $EM_Booking->get_admin_url(); ?>" class="button-secondary em-cart-table-actions-edit">
							<?php _e('edit booking','em-pro'); ?>
						</a>
						<span class="em-cart-table-details-triggers">
							<a href="#" class="button-secondary em-cart-table-details-show" rel="<?php echo $EM_Booking->get_event()->event_id; ?>" id="em-cart-table-details-show-<?php echo $EM_Booking->get_event()->event_id; ?>">
								+ <?php _e('details','em-pro'); ?>
							</a>
							<a href="#" class="button-secondary em-cart-table-details-hide hidden" rel="<?php echo $EM_Booking->get_event()->event_id; ?>" id="em-cart-table-details-hide-<?php echo $EM_Booking->get_event()->event_id; ?>">
								- <?php _e('details','em-pro'); ?>
							</a>
						</span>
						<?php do_action('em_multiple_booking_table_booking_actions', $EM_Booking, $EM_Multiple_Booking); ?>
					</div>
					<?php
