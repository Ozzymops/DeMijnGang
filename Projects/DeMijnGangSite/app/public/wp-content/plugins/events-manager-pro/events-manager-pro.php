...
define('EMP_VERSION', '3.3.1');
define('EM_MIN_VERSION', '6.5');
...
class EM_Pro {
	...
	public static function init(){
		...
		if( get_option('dbem_rsvp_enabled') ){
			...
			include('add-ons/list-table-forms.php'); // list table forms trait
			include('add-ons/bookings-form/bookings-form.php');
			include('add-ons/bookings-form/list-table-form-fields.php'); // list table form field settings
			// load gateways
