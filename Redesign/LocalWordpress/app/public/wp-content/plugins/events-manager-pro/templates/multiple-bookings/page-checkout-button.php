...
do_action('em_checkout_form_before_buttons', $EM_Multiple_Booking); //do not delete
?>
	<div class="em-booking-section em-booking-form-buttons em-booking-buttons">
		<?php do_action('em_checkout_form_buttons_header', $EM_Multiple_Booking); //do not delete ?>
		...
		<?php else: //Display normal submit button ?>
			...
			$button_text = $EM_Multiple_Booking && $EM_Multiple_Booking->get_price_base() > 0 ?  str_replace('%s', $EM_Multiple_Booking->get_price(true), get_option('dbem_bookings_submit_button_paid')) : get_option('dbem_bookings_submit_button');
			?>
		...
		<?php endif; ?>
		<?php do_action('em_checkout_form_buttons_footer', $EM_Multiple_Booking); //do not delete ?>
	</div>
<?php
do_action('em_checkout_form_footer_after_buttons', $EM_Multiple_Booking); //do not delete